...
| Aryan |**Critical Thinking** - I was able to make the main menu and a panel for the sports simulation, will play around with database after break. Most time was spent brainstorming and thinking about how to accomplish this task. **Communcations and Presentations** - I was able to contribute to the scrum board and communicate with my scrum team. **Collaboration** - I was able to collaborate with Pranav on AWS technical difficulties and communicated project ideas to the rest of the scrum team. **Creativity** - I tried to make the JFrames look nice, but I didn't really accomplish that. **Total Score: 18/20.** |
| Aryan Links | N/A |
| Praveen | asdf |
| Praveen Links | asdf |
| Neil | asdf |
