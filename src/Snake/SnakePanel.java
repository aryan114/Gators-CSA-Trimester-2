...
public class SnakePanel extends JPanel implements ActionListener{
    ...
    public void move(){
        //how to move the snake, changes through x and y coordinates
        ...
        switch(direction) {
            //determines which way the snake is moving based on the keys pressed
            case 'U':
                y[0] = y[0] - UNIT_SIZE;
                break;
            case 'D':
    ...
    public void checkApple() {
        //verfies that the snake has actually eaten an apple
